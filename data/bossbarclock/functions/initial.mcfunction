...
execute if score #bossbarclock_print_toggle_clock Config matches 1 if score #bossbarclock_display_method Config matches 0 run tellraw @a ["",{"text":"[Bossbar Clock]: ","color":"yellow","bold":true},{"text":"> Toggle Clock <","underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger showClock add 1"}}]
execute if score #bossbarclock_print_toggle_clock Config matches 2 run tellraw @a ["",{"text":"[Bossbar Clock]: ","color":"yellow","bold":true},{"text":"> Toggle Clock <","underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger showClock add 1"}}]

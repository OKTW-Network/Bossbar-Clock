...
execute if score #bossbarclock_time_12hr Config matches 0 run bossbar set bossbarclock:clock name [{"text":"Day ","color":"white"},{"score":{"name":"#day","objective":"BossbarClock"},"color":"yellow"},{"text":" - ","color":"gray"},{"score":{"name":"#1","objective":"calcu_temp"},"color":"yellow"},{"text":":","color":"white"},{"nbt":"time.minute","storage":"bossbarclock:resources","interpret":true,"color":"yellow"}]
